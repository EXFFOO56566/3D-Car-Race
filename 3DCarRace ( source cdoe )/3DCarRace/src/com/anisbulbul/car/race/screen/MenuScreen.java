...
public class MenuScreen extends GameAssets implements Screen, InputProcessor {
	...
	public void show() {
		...
		addButton(shareButtonTexture, width / 25, height / 10 - height / 20,
				width / 5, width / 5, "SR");
		
		addButton(achievementButtonTexture, 2*width/25 + width / 5, height / 10 - height / 20,
				width / 5, width / 5, "AC");
				
		addButton(rateButtonTexture, 3*width/25 + 2*width / 5, height / 10 - height / 20,
				width / 5, width / 5, "RA");
		
		addButton(leaderboardButtonTexture, 4*width/25 + 3*width / 5, height / 10 - height / 20,
				width / 5, width / 5, "LD");
